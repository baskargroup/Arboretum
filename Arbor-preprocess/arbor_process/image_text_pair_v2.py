...
def process_subfolder(metadata_path,subfolder_path, output_folder):
    ...
    with ThreadPoolExecutor() as executor:
        futures = [executor.submit(create_files_and_json, output_folder, **row.to_dict()) for _, row in values.iterrows()]
...
def create_image_text_pairs(metadata = 'metadata', img_folder='img_folder', output_base_folder='output_folder'):
    ...
    for subfolder in subfolders:
        ...
        process_subfolder(metadata, subfolder, output_folder)
