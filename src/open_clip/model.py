...
def build_model_from_openai_state_dict(state_dict: dict):
    ...
    if vit:
        ...
        assert output_width ** 2 + 1 == state_dict["visual.attnpool.positional_embedding"].shape[0], "Size mismatch building model from openai state dict, {}, {}".format(output_width ** 2 + 1, state_dict["visual.attnpool.positional_embedding"].shape[0])
