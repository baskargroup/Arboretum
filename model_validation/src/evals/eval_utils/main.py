...
try:
    ...
    print(f"Datacomp evaluation modules not found: {e}. Continuing without them.")


def evaluate_model(task_key, model, checkpoint, data_root, dataset_size, batch_size=64):
